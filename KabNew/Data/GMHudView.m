...
@interface GMHudView ()
@property (nonatomic, readonly) GMHUDWindow *hudWindow;
...
- (id)initWithTitle:(NSString *)aTitle loading:(BOOL)isLoading {
    if ((self = [super initWithFrame:CGRectZero])) {
        ...
        // Images
        self.completeImage = [UIImage imageNamed:@"GMHUDView-Check"];
        self.failImage = [UIImage imageNamed:@"GMHUDView-X"];
...
- (void)show {
    ...
    GMHUDWindowViewController *viewController = (GMHUDWindowViewController *)self.hudWindow.rootViewController;
    ...
    [UIView beginAnimations:@"GMHUDViewFadeInWindow" context:nil];
    ...
    [UIView beginAnimations:@"GMHUDViewFadeInContentAlpha" context:nil];
    [UIView setAnimationDelay:0.1];
    [UIView setAnimationDuration:0.2];
    self.alpha = 1.0f;
    [UIView commitAnimations];
    
    [UIView beginAnimations:@"GMHUDViewFadeInContentFrame" context:nil];
    [UIView setAnimationDelay:0.1];
...
- (void)dismissAnimated:(BOOL)animated {
    ...
    [UIView beginAnimations:@"GMHUDViewFadeOutContentFrame" context:nil];
    [UIView setAnimationDuration:0.2];
    ...
    [UIView beginAnimations:@"GMHUDViewFadeOutContentAlpha" context:nil];
    [UIView setAnimationDelay:0.1];
    [UIView setAnimationDuration:0.2];
    self.alpha = 0.0f;
    [UIView commitAnimations];
    
    [UIView beginAnimations:@"GMHUDViewFadeOutWindow" context:nil];
    self.hudWindow.alpha = 0.0f;
    [UIView commitAnimations];
...
- (void)setTransformForCurrentOrientation:(BOOL)animated {
    ...
    if (animated) {
        [UIView beginAnimations:@"GMHUDViewRotationTransform" context:nil];
